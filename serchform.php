<form role="search" class="p-search search-form" method="get" action="<?php echo esc_url(home_url('/')); ?>">
  <label class="c-text-box--has-icon">
    ...
    <input type="search" class="c-text-box--has-icon__inner search-field" name="s" placeholder="<?php echo esc_attr_x('検索', 'placeholder', 'tsuruten-web.com') ?>" value="<?php echo get_search_query() ?>" title="<?php echo esc_attr_x('Search for:', 'label', 'tsuruten-web.com') ?>">
